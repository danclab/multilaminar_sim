...
python -u /pbs/home/b/bonaiuto/laminar_erf/pipeline_15c_coreg_error_bem_simulations.py > /sps/isc/bonaiuto/laminar_erf/output/output_coregerr_bem_$SLURM_ARRAY_TASK_ID.txt 2> /sps/isc/bonaiuto/laminar_erf/output/error_coregerr_bem_$SLURM_ARRAY_TASK_ID.txt ${SLURM_ARRAY_TASK_ID}
