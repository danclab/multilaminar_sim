...
python -u /pbs/home/b/bonaiuto/laminar_erf/pipeline_14b_snr_agm_simulations.py > /sps/isc/bonaiuto/laminar_erf/output/output_snr_agm_$SLURM_ARRAY_TASK_ID.txt 2> /sps/isc/bonaiuto/laminar_erf/output/error_snr_agm_$SLURM_ARRAY_TASK_ID.txt ${SLURM_ARRAY_TASK_ID}
