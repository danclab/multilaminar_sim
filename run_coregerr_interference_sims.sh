...
python -u /pbs/home/b/bonaiuto/laminar_erf/pipeline_13_coreg_error_interference_simulations.py > /sps/isc/bonaiuto/laminar_erf/output/output_coregerr_interference_$SLURM_ARRAY_TASK_ID.txt 2> /sps/isc/bonaiuto/laminar_erf/output/error_coregerr_interference_$SLURM_ARRAY_TASK_ID.txt ${SLURM_ARRAY_TASK_ID}
