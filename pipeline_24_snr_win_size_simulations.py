...
def run(subject_id, session_id, sim_vertex, snr, win_size, json_file):
    ...
    out_path = os.path.join(parameters['output_path'], 'snr_win_size_simulations')
    ...
    if not os.path.exists(output_file):
        ...
        sim_vx_res['layerFs'] = np.zeros((n_layers, n_layers, 1201))
        ...
        with spm_context() as spm:
            ...
            for l in range(n_layers):
                ...
                [layerFs, wois] = sliding_window_model_comparison(
                    sim_vertex,
                    nas,
                    lpa,
                    rpa,
                ...
                sim_vx_res['layerFs'][:,l,:] = layerFs
                sim_vx_res["wois"] = wois
