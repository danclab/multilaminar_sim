...
def run(subject_id, session_id, sim_vertex, snr, win_size, json_file):
    ...
    out_path = os.path.join(parameters['output_path'], 'snr_interference_simulations')
    ...
    if not os.path.exists(output_file):
        ...
        tmp_dir = op.join(out_path, f'sim_snr_interference_{sim_vertex}_{snr}_{win_size}')
...
if __name__=='__main__':
    ...
    snr_levels = [-500, -100, -50, -35, -20, -10, -5, 0, 5]
    win_sizes = [50]
