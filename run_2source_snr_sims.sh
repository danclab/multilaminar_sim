...
python -u /pbs/home/b/bonaiuto/laminar_erf/pipeline_04_2source_snr_simulations.py > /sps/isc/bonaiuto/laminar_erf/output/output_2src_snr_$SLURM_ARRAY_TASK_ID.txt 2> /sps/isc/bonaiuto/laminar_erf/output/error_2src_snr_$SLURM_ARRAY_TASK_ID.txt ${SLURM_ARRAY_TASK_ID}
