function vba_motor_epoch_mefI(patch_size)

in_fname=sprintf('mefI_aligned_all_layer_F_patch_size_%0.1f.mat', patch_size);
...
out_fname=sprintf('mefI_aligned_overtime_family_patch_size_%0.1f.mat', patch_size);
