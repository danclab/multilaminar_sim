...
def run(subject_id, session_id, sim_vertex, err_level, win_size, json_file):
    ...
    out_path = os.path.join(parameters['output_path'], 'coreg_err_pink_simulations')
    ...
    if not os.path.exists(output_file):
        ...
        tmp_dir = op.join(out_path, f'sim_coregerr_pink_{sim_vertex}_{err_level}_{win_size}')
