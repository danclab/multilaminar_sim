function vba_motor_epoch_mefI_win_size()

win_sizes=[10,25,50];

for w_idx=1:length(win_sizes)
    win_size=win_sizes(w_idx);
    in_fname=sprintf('mefI_aligned_all_layer_F_win_size_%d.mat', win_size);
    ...
    out_fname=sprintf('mefI_aligned_overtime_family_win_size_%d.mat', win_size);
